...
public final class GatewayRequestPolicy {
    ...
    private static final String BUYER_PRODUCT_PREFIX = "/api/v1/buyer/products";
    private static final String BUYER_GUEST_ORDER_PREFIX = "/api/v1/buyer/guest/orders";
    ...
    public static boolean isPublicBuyerPath(String path) {
        ...
        String normalized = normalizeServicePrefixedPath(path);
        return normalized.startsWith(BUYER_PRODUCT_PREFIX)
                || normalized.startsWith(BUYER_GUEST_ORDER_PREFIX);
    }
