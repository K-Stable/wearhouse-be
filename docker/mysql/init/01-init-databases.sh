...
CREATE DATABASE IF NOT EXISTS \`${CART_DB_NAME:-wearhouse_cart}\` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
GRANT ALL PRIVILEGES ON \`${CART_DB_NAME:-wearhouse_cart}\`.* TO '${MYSQL_USER:-wearhouse}'@'%';
