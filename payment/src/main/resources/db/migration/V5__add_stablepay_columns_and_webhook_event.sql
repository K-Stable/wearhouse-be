ALTER TABLE payment_transaction
    ...
    ADD COLUMN nonce VARCHAR(120) NULL AFTER merchant_key,
    ADD COLUMN deadline VARCHAR(120) NULL AFTER nonce,
    ADD COLUMN payload_hash VARCHAR(128) NULL AFTER deadline,
    ADD COLUMN payer_address VARCHAR(100) NULL AFTER payload_hash,
